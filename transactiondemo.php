...
private $pdo = null;
 ...
 function transfer($from, $to, $amount) {
        ...
        try {
            ...
            $sql = 'SELECT amount FROM cust_acc WHERE user_name=:from';
            ...
            $sql_update_from = 'UPDATE cust_acc
...
$obj->transfer("Jiya","Archita",1000);
